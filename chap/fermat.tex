...
Für alle Charakteristiken $p > 2$ und Grade $d = p^n + 1$ mit $n \in \mathbb N$ liegen auf $F_d$ die Familien von Geraden (I)--(III). Ist weiterhin $p=3$, dann liegen zusätzlich die Geraden \note Wie sieht es allgemein aus?
