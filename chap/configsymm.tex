...
\begin{equation}
\mathbb U(4, \mathbb F_{q^2})/(\mu_d \mathbb I) \rtimes \Gal \overline{\mathbb F_p}/{\mathbb F_p} \subset G_l(F_d).
\end{equation}
...
\begin{theorem}
Die projektive unitäre Gruppe $\mathbb U(4, \mathbb F_{\!q^2}) / (\mu_d \mathbb I)$ operiert auf der Fermat-Fläche $F_d(\mathbb F_{\!q^2}) = \mathbb P(\{v \in \mathbb F_{\!q^2}^{\,4}: \|v\| = 0\})$ transitiv.
\end{theorem}
\begin{proof}
