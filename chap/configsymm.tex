...
\begin{equation}
G_l = G_l(S) = \{ g \in \PGaL{n+1}K \colon gS = S \} \subset \PGaL{n+1}K.
\end{equation}
\end{defin}
...
\begin{equation}
G_k = G_k(S) = \{ \sigma \in \Sym(L) \colon (l_1, l_2) \in E \Leftrightarrow (\sigma(l_1), \sigma(l_2)) \in E \}.
\end{equation}
\end{defin}
...
\begin{equation}
\begin{split}
\Lcl(I)_{a,b}  \colon\qquad	&(1:\zeta^a:0:0)(0:0:1:\zeta^b), \\
\Lcl(II)_{a,b} \colon\qquad	&(1:0:\zeta^a:0)(0:1:0:\zeta^b), \\
\Lcl(III)_{a,b}\colon\qquad	&(1:0:0:\zeta^a)(0:1:\zeta^b:0).
\end{split}
\end{equation}
