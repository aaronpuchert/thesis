...
Sei also nun $F_1 = \left. F \right|_{X_0=1} \in K[X_1, X_2, X_3]$ Form vom Grad~$d$ mit $F_1(0,0,0) = 0$. Sei $\mathfrak m = (X_1, X_2, X_3) = \{ f \in K[X_1, X_2, X_3] : f(0) = 0 \}$ das maximale Ideal des~$\aff 3$ im Punkt~$0$, dann ist $F_1 \in \mathfrak m$. Der Tangentialraum $T_{0,X}$ an~$X$ in~$(0,0,0)$ ist der Nullraum der Linearisierung~$L$ von~$F_1$, d.\,h. dem Bild von~$F_1$ unter $\mathfrak m \to \mathfrak m/\mathfrak m^2 \cong T_{0,\aff 3}^*$. Nach obiger Annahme ist $L = X_3$.
